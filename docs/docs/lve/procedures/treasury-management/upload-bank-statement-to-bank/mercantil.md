...
Para la exportación de los archivos desde ADempiere al banco mercantil, [ERPyA](http://adeos.business) soporta los siguientes formatos facilitados por el banco, que pueden ser descargados para su análisis y adaptación.
